...
## Plato dossier portrait

- **Asset:** `public/images/plato-silanion-berlin.webp`
- **Subject:** Marble portrait of Plato, a Roman copy after a fourth-century BCE Greek original
- **Source:** [Wikimedia Commons — Marble bust of the Greek philosopher Plato, Altes Museum, Berlin](https://commons.wikimedia.org/wiki/File:Marble_bust_of_the_Greek_philosopher_Plato._Roman_copy_(1st_century_CE)_of_an_original_(350-340_BCE)._Altes_Museum,_Berlin.jpg)
- **Photographer:** Osama Shukir Muhammed Amin FRCP(Glasg)
- **License:** [Creative Commons Attribution-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/)
- **Site adaptation:** Resized, WebP-compressed, responsively cropped, and CSS-toned to grayscale and sepia. The adapted image remains available under CC BY-SA 4.0.
- **Current use:** The shared dossier cover on the homepage, product page, campaign page, cart, and saved-item preview.

The source credit and license link appear beneath every full-size cover. Compact cart and saved-item covers are reproductions of that credited product artwork. Keep the full credit in the eventual PDF image ledger and with any future standalone use of this asset.
