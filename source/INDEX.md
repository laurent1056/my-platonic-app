...
On 2026-09-03, the existing Platonic Ideal product artifacts were preserved in
the immutable snapshot [`source/adhoc/2026-09-03-project-baseline/`](./adhoc/2026-09-03-project-baseline/).
It contains 24 files copied from the pre-PM-Brain application and project
folder: the canonical CSV, product documentation, design references, and the
older vision documents. The corresponding synthesis records live under
[`ingestion/adhoc/`](../ingestion/adhoc/). The snapshot is an audit anchor and
